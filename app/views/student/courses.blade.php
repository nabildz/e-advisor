...
{{ Form::open(array('route' => 'store_courses','method' => 'post','class' => 'ui large form')) }}
<input id="coursesNo" type="hidden" name="coursesNo" value="1">
	<div id="courses">
...
<div class="ui two column grid">
	<div class="row">
		<div class="wide column"><button  type="button" class="big ui green button fluid" onclick="addCourse()">اضافة المادة اخري</button> </div>
		<div class="wide column"><button type="submit" class="big ui blue button fluid">حفظ المواد</button> </div>
...
<script>
            ...
            function jsfunction(v,id){
                ...
                else if(v.toUpperCase() == "IT"){
				  if( itemid == 'GS'+id || itemid == 'GE'+id){
						$( this ).attr("style","display:block");
                }
