...
class GuideController extends \BaseController {
    ...
    return View::make('student.courses');
	}
	...
	public function guide()
	{
		...
		$final_plans = array_merge($root_index,$root_plan, $genral_plan,$department_plan);
...
// 	$looper--;
// }
// 	    return View::make('student.guide', array('courses' => $sorted));
	}
